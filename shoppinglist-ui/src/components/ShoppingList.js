                    ...
                    return(
                        <div className="ShoppingListItem" key={idx}>
                            ...
                            <div className="ShoppingListItemDetail collapsible-item">
                                <label className="item-label" for={selectedFile}>Upload File </label><input className="item" type="file" id={selectedFile} name={selectedFile} onChange={this.handleFileChange}  data-index={item.index} data-internalindex={idx} data-name="selectedFile" />
                                <label className="item-label" for={store}>Store </label><input className="item" type="text" id={store} name={store} value={this.props.items[idx].store} onChange={this.props.onInputChanged}  data-index={item.index} data-internalindex={idx} data-name="store" />
                                <label className="item-label" for={itemName}>Name </label><input className="item" type="text" id={itemName} name={itemName} value={this.props.items[idx].itemName} onChange={this.props.onInputChanged}  data-index={item.index} data-internalindex={idx} data-name="itemName" />
                                <label className="item-label" for={itemBrand}>Brand </label><input className="item" type="text" id={itemBrand} name={itemBrand} value={this.props.items[idx].itemBrand} onChange={this.props.onInputChanged}  data-index={item.index} data-internalindex={idx}  data-name="itemBrand" />
                                <label className="item-label" for={itemQuantity}>Quantity </label><input className="item" type="text" id={itemQuantity} name={itemQuantity} value={this.props.items[idx].itemQuantity} onChange={this.props.onInputChanged}  data-index={item.index} data-internalindex={idx} data-name="itemQuantity" />
                                <label className="item-label" for={itemPrice}>Price </label><input className="item" type="text" id={itemPrice} name={itemPrice} value={this.props.items[idx].itemPrice} onChange={this.props.onInputChanged}  data-index={item.index} data-internalindex={idx} data-name="itemPrice" />
                                <label className="item-label" for={itemPriority}>Priority </label><select className="item" id={itemPriority} name={itemPriority} value={this.props.items[idx].itemPriority} onChange={this.props.onInputChanged}  data-index={item.index} data-internalindex={idx} data-name="itemPriority">
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                                </select>
                                <label className="item-label" for={itemStatus}>Status </label><select className="item" id={itemStatus} name={itemStatus} value={this.props.items[idx].itemStatus} onChange={this.props.onInputChanged}  data-index={item.index} data-internalindex={idx} data-name="itemStatus">
                                    <option value="1">New</option>
                                    <option value="2">Collected</option>
                                    <option value="3">Out of Stock</option>
                                    <option value="4">Paid</option>
                                </select>
                                <label className="item-label" for={itemRemark}>Remark </label><textarea className="item" rows="10" cols="30" id={itemRemark} name={itemRemark} value={this.props.items[idx].itemRemark} onChange={this.props.onInputChanged}  data-index={item.index} data-internalindex={idx} data-name="itemRemark"></textarea>
                                {image}
                                <div className="ShoppingListItemAction">
                                    <button className="actionButton" type="submit" onClick={this.handleSaveClick} data-index={item.index} data-internalindex={idx}>Save</button>
                                    <button className="actionButton" type="submit" onClick={this.handleDeleteClick} data-index={item.index} data-internalindex={idx}>Delete</button>
                                </div>
                            </div>
                        </div>
                    )
